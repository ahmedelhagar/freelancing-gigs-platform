...
<?php $this->load->view('include/userSideBar_view.php'); ?>
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 s-pro projects">
        ...
        <h3 class="projects">تصفح معرض أعمال <?php echo $userviewed[0]->firstname.' '.$userviewed[0]->lastname; ?></h3>
...
echo base_url().'users/p/'.str_replace(' ','-',$product->title).'/'.$product->id.'/';
...
?>"><?php echo $product->title; ?></a></h6>
            ...
            <?php }}else{
                ...
                echo '<h3 class="no-data">لايوجد أعمال لعرضها</h3>';

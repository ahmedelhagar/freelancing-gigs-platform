...
<div class="col-lg-8 col-md-8 col-sm-12 float-right px-2 py-2">
  <div class="col-12 float-right">
    <a href="<?php echo base_url('istsharhcadmin/projects/'); ?>" class="btn btn-success my-3">الكل</a> |
    <a href="<?php echo base_url('istsharhcadmin/projects/fight'); ?>" class="btn btn-danger my-3">نزاع</a> |
    <a href="<?php echo base_url('istsharhcadmin/projects/active'); ?>" class="btn btn-success my-3">النشطة</a> | 
    <a href="<?php echo base_url('istsharhcadmin/projects/complete'); ?>" class="btn btn-success my-3">المكتملة</a> | 
    <a href="<?php echo base_url('istsharhcadmin/projects/run'); ?>" class="btn btn-success my-3">قيد التنفيذ</a> | 
    <a href="<?php echo base_url('istsharhcadmin/projects/unactive'); ?>" class="btn btn-success my-3">الغير نشطة</a> | 
    <a href="<?php echo base_url('istsharhcadmin/projects/closed'); ?>" class="btn btn-success my-3">المغلقة</a>
  </div>
<table class="table table-striped col-12 float-right px-2 py-2" style="background:#fff;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a class="btn btn-success" style="border-radius:0px;" href="<?php echo base_url('istsharhcadmin/publishCheck/'.$item->id.'/projects'); ?>">نشر</a>
      <?php } ?>
      ...
      <td>
        <a class="btn btn-danger" style="border-radius:0px;" href="<?php echo base_url().'istsharhcadmin/delete/items/'.$item->id.'/?m=istsharhcadmin/projects'; ?>"><span class="fa fa-trash"></span> حذف</a>
      </td>
    </tr>
    <?php $i++;}} ?>
  </tbody>
